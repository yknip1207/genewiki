...
__version__ = '$Id: wikipedia_family.py 8241 2010-06-04 07:03:17Z xqt $'
...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'eu', 'hi', 'el', 'ht', 'te', 'ka', 'ceb', 'mk', 'la', 'roa-rup',
            'az', 'br', 'sh', 'lb', 'bs', 'jv', 'mr', 'is', 'lv', 'cy', 'tl',
            'pms', 'sq', 'be-x-old', 'bpy', 'ta', 'oc', 'bn', 'an', 'be', 'io',
            'sw', 'fy', 'nds', 'scn', 'af', 'qu', 'gu', 'su', 'lmo', 'zh-yue',
            'ast', 'ur', 'nap', 'ku', 'ml', 'bat-smg', 'wa', 'cv', 'ksh', 'ga',
            'hy', 'tg', 'yo', 'roa-tara', 'vec', 'kn', 'gd', 'yi', 'uz', 'pam',
            'os', 'zh-min-nan', 'mi', 'sah', 'als', 'tt', 'kk', 'nah', 'li',
            'arz', 'hsb', 'glk', 'co', 'gan', 'ia', 'bcl', 'ne', 'mn', 'pnb',
            'fiu-vro', 'nds-nl', 'vls', 'fo', 'tk', 'sa', 'am', 'si', 'dv',
            'bar', 'nrm', 'pag', 'rm', 'gv', 'map-bms', 'my', 'sco', 'diq',
            'se', 'wuu', 'fur', 'lij', 'ug', 'bh', 'mt', 'nov', 'mzn', 'csb',
            'ilo', 'zh-classical', 'pi', 'lad', 'km', 'mg', 'sc', 'ang', 'frp',
            'kw', 'hif', 'bo', 'ckb', 'hak', 'pdc', 'haw', 'szl', 'ps', 'pa',
            'ie', 'xal', 'kv', 'crh', 'to', 'stq', 'myv', 'ace', 'gn', 'ln',
            'krc', 'nv', 'ky', 'mhr', 'ext', 'cbk-zam', 'arc', 'jbo', 'ty',
            'wo', 'eml', 'kab', 'tpi', 'so', 'pap', 'zea', 'fj', 'srn', 'ay',
            'ba', 'ig', 'or', 'dsb', 'ce', 'kl', 'kg', 'udm', 'lo', 'rmy', 'cu',
            'ab', 'mwl', 'kaa', 'pcd', 'sm', 'av', 'ks', 'tet', 'got', 'sd',
            'mdf', 'na', 'bm', 'pnt', 'pih', 'iu', 'cdo', 'as', 'bug', 'ee',
            'chr', 'om', 'bi', 'zu', 'za', 'ti', 'ts', 'ss', 've', 'ha', 'sg',
            'dz', 'ch', 'cr', 'xh', 'ak', 'ik', 'lbe', 'ki', 'tn', 'bxr', 'rw',
