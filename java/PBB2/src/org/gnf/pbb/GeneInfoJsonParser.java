...
public class GeneInfoJsonParser {
	...
	public static GeneObject newGeneFromId(int id) throws JsonParseException, JsonMappingException, IOException {
		...
		gene.GoFunctions.setGeneOntologies(
				rootNode.path("go").path("MF").findValuesAsText("term"), 
				rootNode.path("go").path("MF").findValuesAsText("ids"));
		gene.GoComponents.setGeneOntologies(
				rootNode.path("go").path("CC").findValuesAsText("term"), 
				rootNode.path("go").path("CC").findValuesAsText("ids"));
		gene.GoProcesses.setGeneOntologies(
				rootNode.path("go").path("BP").findValuesAsText("term"), 
				rootNode.path("go").path("BP").findValuesAsText("ids"));
	...
	public static void main(String[] args) {
		try {
			GeneObject gene = newGeneFromId(410);
